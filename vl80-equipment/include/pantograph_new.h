...
public:
    ...
    /// Задать поток воздуха в цилиндр пневмопривода токоприёмника
    void setPneumodriveFlow(double flow);
    ...
    /// Давление в цилиндре пневмопривода токоприёмника, МПа
    double getPneumodrivePressure() const;
...
private:
    ...
    /// Поток воздуха в цилиндр пневмопривода токоприёмника
    double Qc = 0.0;
